...
# IsolateEc2Stack(app, "IsolateEc2Stack", env=cdk.Environment(account="31761", region="eu-central-1"), vpc_id=VPC_ID)
# Ec2IsolationCdkDemoStack(app, "ec2-isolation-cdk-demo",env=cdk.Environment(account="3131", region="eu-central-1"), vpc_id=VPC_ID)
app.synth()
